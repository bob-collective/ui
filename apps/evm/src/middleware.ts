...
export const config: MiddlewareConfig = {
  matcher: [
     ...
     */
    '/((?!_next/static|_next/image|favicon.ico|assets|api|fusion-api|gateway-api|btc-api|blockscout-api|geoblock-check|site.webmanifest|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)'
  ]
};
