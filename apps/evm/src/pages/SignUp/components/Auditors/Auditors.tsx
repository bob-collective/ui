        ...
        <Dd style={{ width: '100%' }}>
          <Flex wrap alignItems='center' elementType='span' gap='2xl' justifyContent='space-around'>
            <a
              ...
              target='_blank'
            >
              <img alt='Trails of Bits auditor' height='24' src={trailsOfBitsSrc} width='40' />
            </a>
            <a
              ...
              target='_blank'
            >
              <img alt='Common Prefix auditor' height='10' src={commonPrefixSrc} width='105' />
            </a>
            <a
              ...
              target='_blank'
            >
              <img alt='OtterSec auditor' height='16' src={otterSecSrc} width='76' />
            </a>
          </Flex>
        </Dd>
      </DlGroup>
