const ExternalLinks = {
  ...
  PRIVACY_POLICY:
    'https://cdn.prod.website-files.com/6620e8932695794632789d89/675872861db67a29ec01d237_BOB%20Foundation%20-%20Privacy%20Policy.pdf',
  SAFE: 'https://safe.gobob.xyz/welcome',
  DISCORD: 'https://discord.gg/gobob',
  X: 'https://x.com/build_on_bob',
  BANXA: 'https://checkout.banxa.com/?coinType=ETH&fiatType=EUR&blockchain=BOB'
};
