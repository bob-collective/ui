import type { AlignItems, AlignSelf, Direction, JustifyContent, ResponsiveProp, Spacing, Wrap } from '../../theme';

import { styled } from 'styled-components';

import { StyledMarginProps, StyledPaddingProps } from '../../hooks';
