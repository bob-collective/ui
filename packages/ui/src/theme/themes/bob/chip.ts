...
const chip: ChipTheme = {
  ...
  size: {
    s: {
      base: { height: '1.5rem', paddingLeft: '0.25rem', paddingRight: '0.25rem', ...typography('s') },
      content: { paddingLeft: '0.25rem', paddingRight: '0.25rem' }
    },
    md: {
      base: { height: '1.75rem', paddingLeft: '0.25rem', paddingRight: '0.25rem', ...typography('md') },
      content: { paddingLeft: '0.5rem', paddingRight: '0.5rem' }
    },
    lg: {
      base: { height: '2rem', paddingLeft: '0.5rem', paddingRight: '0.5rem', ...typography('lg') },
      content: { paddingLeft: '0.5rem', paddingRight: '0.5rem' }
    }
  }
};
