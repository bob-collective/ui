...
export { Modal, ModalBody, ModalFooter, ModalHeader, ModalDivider } from './Modal';
export type { ModalBodyProps, ModalFooterProps, ModalHeaderProps, ModalProps, ModalDividerProps } from './Modal';
