...
import { ETH, L1_CHAIN, L2_CHAIN, isProd, wstETH } from '@/constants';
...
const depositsUrl = `${process.env.NEXT_PUBLIC_INDEXER_URL}/bridge-deposits-${indexerNetworkL1}/1.0/gn`;

const withdrawUrl = `${process.env.NEXT_PUBLIC_INDEXER_URL}/bridge-withdraws-${indexerNetworkL2}/1.0/gn`;
